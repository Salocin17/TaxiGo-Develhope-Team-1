...
export default function TaxiSidebar() {
  ...
  return (
    ...
    >
      ...
      <SideNav.Nav defaultSelected="/">
        ...
        <NavItem eventKey="TaxiStorico" selected={selected === 'TaxiStorico'}>
          <NavIcon><i className="fa fa-history" style={{fontSize: "1.5em"}}></i></NavIcon>
          <NavText>Storico</NavText>
        </NavItem>
        <NavItem eventKey="TaxiAccount" selected={selected === 'TaxiAccount'}>
