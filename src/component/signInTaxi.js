    ...
    <div className="wrapper">
      ...
      {showSuccessSnackbar && (
        ...
        {showErrorSnackbar && (
          ...
          >
            Si è verificato un errore durante la registrazione, tassista già presente
            <FontAwesomeIcon
              icon={faClose}
              style={{ float: "right", marginTop: "0.3rem" }}
              type="button"
                ...
                <div class="row">
                  <div class="col-auto">
                    ...
                    <input
                      ...
                      id="licenza"
                      value={licenza}
                      onChange={(event) => setLicenza(event.target.value)} required
                    />
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-auto">
                    ...
                    <input
                      ...
                      id="prov"
                      value={prov}
                      onChange={(event) => setProv(event.target.value)} required
                    />
                  </div>
                </div>
                <div class="row">
